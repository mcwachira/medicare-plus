                    ...
                    <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                        ...
                        <div>
                            <div className='lg:w-[570px]'>
                                ...
                                <p className='text__para'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illo cupiditate repudiandae magnam dicta alias, perspiciatis placeat et, minima libero modi ipsum. Blanditiis magnam quos animi.</p>
                    ...
                    <div className="flex items-center justify-between flex-col lg:flex-row">
                        ...
                        <div className="xl:w-[670px]">
                            ...
                            <ul className="pl-4">
                                ...
                                <li className="text__para">3. View our physicians who are accepting new patients, use the online scheduling took to select an appointment time.</li>
                            </ul>
                            <Link to='/'>
